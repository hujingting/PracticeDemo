...
import com.tutao.practicedemo.model.Emotion;
...
public class FaceRainView extends View {
    ...
    private final List<Emotion> mEmoticonList = new ArrayList<>();
    ...
    public FaceRainView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FaceRainView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mEmoticonList.size() > 0){
            for (int i = 0; i < mEmoticonList.size(); i++) {
                Emotion emoticon = mEmoticonList.get(i);
    ...
    private void initAndResetData(Conf conf) {
        ...
        while(currentDuration < DEFAULT_APPEAR_DURATION){
            Emotion.Builder emoticonBuilder = new Emotion.Builder().bitmap(mBaseBitmaps.get(i % type));
    ...
    public void setAutoRecycleBitmap(boolean b) {
...
//            emoticonWidthPixel = builder.emoticonWidthPixel;
        ...
        public Conf bitmaps(List<Bitmap> val) {
            bitmaps = val;
            return this;
        }

        public Conf emoticonHeightPixel(int val) {
            emoticonHeightPixel = val;
            return this;
        }

        public Conf emoticonWidthPixel(int val) {
