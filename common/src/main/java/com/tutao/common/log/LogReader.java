...
public class LogReader extends Thread {
    ...
    @Override
    public void run() {
        MyLog.i(TAG, "log reader(catcher) is running..---------------------------");
        ...
        try {
            ...
            MyLog.i(TAG, "MyLog reader(catcher) and bufferwriter has closed. ------------------");
            try {
                if (mReader != null) {
                    mReader.close();
                    mReader = null;
    ...
    public static void logSystemInfo() {
        ...
        //android.util.MyLog.w("system", "android.os.Build.VERSION.SDK:"
