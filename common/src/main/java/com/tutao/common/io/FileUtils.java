 ...
 */
package com.tutao.common.io;

import com.litesuits.common.io.*;
...
public class FileUtils {
    ...
    public static void touch(File file) throws IOException {
        if (!file.exists()) {
            ...
            com.litesuits.common.io.IOUtils.closeQuietly(out);
        }
    ...
    public static boolean contentEquals(File file1, File file2) throws IOException {
        ...
        try {
            ...
            return com.litesuits.common.io.IOUtils.contentEquals(input1, input2);

        } finally {
            com.litesuits.common.io.IOUtils.closeQuietly(input1);
            com.litesuits.common.io.IOUtils.closeQuietly(input2);
        }
    }
     ...
     * false otherwise
     * @throws IOException in case of an I/O error
     * @see com.litesuits.common.io.IOUtils#contentEqualsIgnoreEOL(Reader, Reader)
     * @since 2.2
     */
    public static boolean contentEqualsIgnoreEOL(File file1, File file2, String charsetName) throws IOException {
        ...
        try {
            ...
            return com.litesuits.common.io.IOUtils.contentEqualsIgnoreEOL(input1, input2);
    ...
    public static long copyFile(File input, OutputStream output) throws IOException {
        ...
        try {
            return com.litesuits.common.io.IOUtils.copyLarge(fis, output);
        } finally {
            fis.close();
        }
    }
    ...
    private static void doCopyFile(File srcFile, File destFile, boolean preserveFileDate) throws IOException {
        ...
        try {
            ...
            com.litesuits.common.io.IOUtils.closeQuietly(output);
            com.litesuits.common.io.IOUtils.closeQuietly(fos);
            com.litesuits.common.io.IOUtils.closeQuietly(input);
            com.litesuits.common.io.IOUtils.closeQuietly(fis);
        }
    ...
    public static void copyInputStreamToFile(InputStream source, File destination) throws IOException {
        try {
            ...
            try {
                com.litesuits.common.io.IOUtils.copy(source, output);
                output.close(); // don't swallow close Exception if copy completes normally
            } finally {
                com.litesuits.common.io.IOUtils.closeQuietly(output);
            }
        } finally {
            com.litesuits.common.io.IOUtils.closeQuietly(source);
        }
    }
    ...
    public static String readFileToString(File file, Charset encoding) throws IOException {
        ...
        try {
            ...
            return com.litesuits.common.io.IOUtils.toString(in, com.litesuits.common.io.Charsets.toCharset(encoding));
        } finally {
            com.litesuits.common.io.IOUtils.closeQuietly(in);
        }
    }
    ...
    public static String readFileToString(File file, String encoding) throws IOException {
        return readFileToString(file, com.litesuits.common.io.Charsets.toCharset(encoding));
    }
    ...
    public static byte[] readFileToByteArray(File file) throws IOException {
        ...
        try {
            in = openInputStream(file);
            return com.litesuits.common.io.IOUtils.toByteArray(in, file.length());
        } finally {
            com.litesuits.common.io.IOUtils.closeQuietly(in);
        }
    }
    ...
    public static List<String> readLines(File file, Charset encoding) throws IOException {
        ...
        try {
            in = openInputStream(file);
            return com.litesuits.common.io.IOUtils.readLines(in, com.litesuits.common.io.Charsets.toCharset(encoding));
        } finally {
            com.litesuits.common.io.IOUtils.closeQuietly(in);
        }
    }
    ...
    public static List<String> readLines(File file, String encoding) throws IOException {
        return readLines(file, com.litesuits.common.io.Charsets.toCharset(encoding));
    }
    ...
    public static void writeStringToFile(File file, String data, Charset encoding, boolean append) throws IOException {
        ...
        try {
            ...
            com.litesuits.common.io.IOUtils.write(data, out, encoding);
    ...
    public static void writeStringToFile(File file, String data, String encoding, boolean append) throws IOException {
        writeStringToFile(file, data, com.litesuits.common.io.Charsets.toCharset(encoding), append);
    }
    ...
    public static void write(File file, CharSequence data, String encoding, boolean append) throws IOException {
        write(file, data, com.litesuits.common.io.Charsets.toCharset(encoding), append);
    }
    ...
    public static void writeLines(File file, String encoding, Collection<?> lines, String lineEnding, boolean append)
        ...
        try {
            ...
            com.litesuits.common.io.IOUtils.writeLines(lines, lineEnding, buffer, encoding);
            buffer.flush();
            out.close(); // don't swallow close Exception if copy completes normally
        } finally {
